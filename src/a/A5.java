...
public class A5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Choose the hash algorithm (e.g., SHA-256):");
        ...
        System.out.println("Hash of '" + input + "' using " + algorithm + " algorithm " + (useSalt ? "with salt" : "without salt") + ": " + hash);
